...
def move_group_python_interface_tutorial(cx, cy, cz):
  ## BEGIN_TUTORIAL
  ...
  #pose_goal.orientation = geometry_msgs.msg.Quaternion(*tf_conversions.transformations.quaternion_from_euler(0.,  0.  , 0.))
  waypoints.append(pose_goal)
  pose_goal2.position.z =0.737046+0.4
  waypoints2.append(copy.deepcopy(pose_goal2))
  pose_goal2.position.x =0.533250
  pose_goal2.position.y =-0.232975
  waypoints2.append(copy.deepcopy(pose_goal2))
...
if __name__=='__main__':
  ...
  cz = 0.755574
  try:
    move_group_python_interface_tutorial(cx, cy, cz)
