...
if __name__ == '__main__':
    ...
    with open("/home/siham/catkin_ws/src/hello_ros/urdf/cube.urdf", "r") as f:
        product_xml = f.read()
    ...
    for num in xrange(0,num_of_cubes):
        bin_y   =   random.uniform(0,0.4)
        bin_x   =   random.uniform(0.15,0.5)
    ...
    with open("/home/siham/catkin_ws/src/hello_ros/urdf/bucket.urdf", "r") as f:
        product_xml = f.read()
